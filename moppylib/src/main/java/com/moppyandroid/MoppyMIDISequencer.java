// Originally written by Sam Archer https://github.com/SammyIAm/Moppy2, modified to use RealTimeSequencer by Noah Reeder
...
public class MoppyMIDISequencer implements MetaEventListener, Closeable {
    ...
    public MoppyMIDISequencer(StatusBus statusBus, MoppyMIDIReceiverSender receiverSender) throws MidiUnavailableException {
        ...
        if (seq == null) { throw new MidiUnavailableException("Unable to create RealTimeSequencerProvider"); }
        seq.open();
