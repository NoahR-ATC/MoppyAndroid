...
public final class SerialPort
{
	 ...
	 * <p>
	 * Calling this function enables event-based serial port callbacks to be used instead of, or in addition to, direct serial port read/write calls or the {@link InputStream}/{@link OutputStream} interface.
	 * <p>
	...
	/**
	 * Returns an {@link InputStream} object associated with this serial port.
	 * <p>
	 * Allows for easier read access of the underlying data stream and abstracts away many low-level read details.
	 * <p>
	 * Note that any time a method is marked as throwable for an {@link IOException} in the official Java
	 * {@link InputStream} documentation, you can catch this exception directly, or you can choose to catch
	 ...
	 * <p>
	 * Make sure to call the {@link InputStream#close()} method when you are done using this stream.
	 *
	 * @return An {@link InputStream} object associated with this serial port.
	 * @see InputStream
	 */
	public final InputStream getInputStream() { return inputStream; }

	/**
	 * Returns an {@link OutputStream} object associated with this serial port.
	 * <p>
	 ...
	 * {@link #setComPortTimeouts(int, int, int)} method).
	 * <p>
	 * Make sure to call the {@link OutputStream#close()} method when you are done using this stream.
	 *
	 * @return An {@link OutputStream} object associated with this serial port.
	 * @see OutputStream
	 */
